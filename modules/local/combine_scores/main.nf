process COMBINE_SCORES {
    ...
    awk 'BEGIN{FS=OFS="\t"} NR==1{print \$0,"technical_pass","score_eligible","related_flag","ancestry_flag","ancestry_distance","primary_analysis"; next} {print \$0,"TRUE","TRUE","FALSE","NOT_ASSESSED","NA","TRUE"}' "\${score_files[0]}" > prs_scores_long.tsv
