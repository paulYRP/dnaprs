...
workflow NFCORE_DNAPRS {
    ...
    script_files = [
        ...
        build_plink_compatibility: file("${projectDir}/bin/build_plink_compatibility.R"),
        import_target: file("${projectDir}/bin/import_target.sh"),
        resolve_target_markers_shell: file("${projectDir}/bin/resolve_target_markers.sh"),
        finalise_target: file("${projectDir}/bin/finalise_target.sh"),
